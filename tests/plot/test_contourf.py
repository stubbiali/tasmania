...
def test_contourf_xy_velocity(isentropic_data, drawer_topography_2d):
    ...
    save_dest = os.path.join(
        baseline_dir, "test_contourf_xy_velocity_nompl.eps"
    )
...
def test_contourf_xy_pressure(isentropic_data, drawer_topography_2d):
    ...
    # make sure the baseline image will exist at the end of this run
    save_dest = os.path.join(
        baseline_dir, "test_contourf_xy_pressure_nompl.eps"
    )
    if os.path.exists(save_dest):
        os.remove(save_dest)
...
def test_contourf_xz_velocity(isentropic_data, drawer_topography_1d):
    ...
    # make sure the baseline image will exist at the end of this run
    save_dest = os.path.join(
        baseline_dir, "test_contourf_xz_velocity_nompl.eps"
    )
    if os.path.exists(save_dest):
        os.remove(save_dest)
...
def test_contourf_yz_velocity(isentropic_data, drawer_topography_1d):
    ...
    # make sure the baseline image will exist at the end of this run
    save_dest = os.path.join(
        baseline_dir, "test_contourf_yz_velocity_nompl.eps"
    )
    if os.path.exists(save_dest):
        os.remove(save_dest)
