...
if __name__ == '__main__':
	for _ in range(100):
		...
		utils.st_isentropic_field(
			g, 'isentropic', 'mass_fraction_of_cloud_liquid_water_in_air', (g.nx, g.ny, g.nz)
		)
		utils.st_isentropic_field(
			g, 'isentropic', 'mass_fraction_of_precipitation_water_in_air', (g.nx, g.ny, g.nz)
		)
		utils.st_isentropic_field(
			g, 'isentropic', 'precipitation', (g.nx, g.ny, 1)
		)
		utils.st_isentropic_field(
