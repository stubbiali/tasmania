...
def test_profile_x(isentropic_dry_data):
	...
	monitor = Plot(
		drawer1, drawer2, interactive=False,
...
def test_profile_z(isentropic_dry_data):
	...
	# instantiate the monitor
	drawer1 = LineProfile(
		grid, field1_name, field1_units, x=x, y=y,
		axis_name='z', axis_units='K', properties=drawer_properties
	)
	...
	# instantiate the monitor
	drawer2 = LineProfile(
		grid, field2_name, field2_units, x=x, y=y,
		axis_name='z', axis_units='K', properties=drawer_properties
	)
...
def test_plot_2d(isentropic_dry_data, drawer_topography_2d):
	...
	# instantiate the drawer
	drawer1 = Contourf(
		grid, 'horizontal_velocity', 'm s^-1', z=z,
	...
	# instantiate the monitor
	drawer2 = Quiver(
		grid, z=z, xcomp_name='x_velocity', ycomp_name='y_velocity',
		xaxis_units='km', yaxis_units='km', properties=drawer_properties
	)
	...
	# instantiate the monitor
	monitor = Plot(
		drawer1, drawer2, topo_drawer, interactive=False,
		figure_properties=figure_properties, axes_properties=axes_properties
	)
