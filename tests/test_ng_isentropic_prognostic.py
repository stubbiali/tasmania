...
from tasmania.python.isentropic.dynamics.ng_prognostic \
	import NGIsentropicPrognostic
from tasmania.python.isentropic.dynamics.implementations.ng_prognostic \
...
def test_factory(data):
	...
	imp_euler_si = NGIsentropicPrognostic.factory(
	...
	imp_rk3ws_si = NGIsentropicPrognostic.factory(
	...
	imp_sil3 = NGIsentropicPrognostic.factory(
...
def test_upwind_si(data):
	...
	imp = NGIsentropicPrognostic.factory(
