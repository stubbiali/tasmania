...
@pytest.mark.mpl_image_compare(baseline_dir='baseline_images/test_subplots_assembler')
def test_plot_1d(isentropic_moist_sedimentation_data,
	...
	save_dest = os.path.join(baseline_dir, 'test_plot_1d.eps')
...
@pytest.mark.mpl_image_compare(baseline_dir='baseline_images/test_subplots_assembler')
def test_plot_1d_share_yaxis(isentropic_moist_sedimentation_data,
							 isentropic_moist_sedimentation_evaporation_data):
	# Make sure the folder tests/baseline_images/test_subplots_composer does exist
	baseline_dir = 'baseline_images/test_subplots_assembler'
	if not os.path.exists(baseline_dir):
	...
	# Make sure the baseline image will exist at the end of this run
	save_dest = os.path.join(baseline_dir, 'test_plot_1d_share_yaxis.eps')
	if os.path.exists(save_dest):
		os.remove(save_dest)
...
@pytest.mark.mpl_image_compare(baseline_dir='baseline_images/test_subplots_assembler')
def test_plot_1d_share_xaxis(isentropic_moist_sedimentation_data,
							 isentropic_moist_sedimentation_evaporation_data):
	# Make sure the folder tests/baseline_images/test_subplots_composer does exist
	baseline_dir = 'baseline_images/test_subplots_assembler'
	if not os.path.exists(baseline_dir):
	...
	# Make sure the baseline image will exist at the end of this run
	save_dest = os.path.join(baseline_dir, 'test_plot_1d_share_xaxis.eps')
	if os.path.exists(save_dest):
		os.remove(save_dest)
...
@pytest.mark.mpl_image_compare(baseline_dir='baseline_images/test_subplots_assembler')
def test_plot_2d_one_row_two_columns(isentropic_moist_sedimentation_data,
									 isentropic_moist_sedimentation_evaporation_data):
	...
	# Make sure the baseline image will exist at the end of this run
	save_dest = os.path.join(baseline_dir, 'test_plot_2d_one_row_two_columns.eps')
	if os.path.exists(save_dest):
		os.remove(save_dest)
...
@pytest.mark.mpl_image_compare(baseline_dir='baseline_images/test_subplots_assembler')
def test_plot_2d_two_rows_two_columns(isentropic_moist_sedimentation_data,
									  isentropic_moist_sedimentation_evaporation_data):
	# Make sure the folder tests/baseline_images/test_subplots_assembler does exist
	baseline_dir = 'baseline_images/test_subplots_assembler'
	if not os.path.exists(baseline_dir):
	...
	# Make sure the baseline image will exist at the end of this run
	save_dest = os.path.join(baseline_dir, 'test_plot_2d_two_rows_two_columns.eps')
	if os.path.exists(save_dest):
		os.remove(save_dest)
