...
from tests.utilities import compare_dataarrays, get_grid_shape, hyp_settings
...
def test_copy(data, backend, dtype, subtests):
    # ========================================
    ...
    for key in shared_keys:
        ...
        compare_dataarrays(
            dst[key], src[key].to_units(dst[key].attrs["units"])
        )
    ...
    for key in shared_keys:
        # with subtests.test(key=key):
        compare_dataarrays(
            dst_dc[key], src[key].to_units(dst[key].attrs["units"])
        )
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_add(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
    ...
    for key in keys:
        if data.draw(
            hyp_st.booleans(), label=f"{key}_in_field_properties_passed"
        ):
    ...
    unshared_keys = tuple(
        key for key in dict1 if key not in dict2 and key != "time"
    )
    unshared_keys += tuple(
        key for key in dict2 if key not in dict1 and key != "time"
    )
    ...
    for key in shared_keys:
        ...
        compare_dataarrays(
            out_a[key], out_val, compare_coordinate_values=False
        )
    ...
    for key in shared_keys:
        ...
        compare_dataarrays(
            out_b[key], out_val, compare_coordinate_values=False
        )
    for key in unshared_keys:
        # with subtests.test(key=key):
        units = field_properties[key]["units"]
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_iadd(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
    ...
    for key in shared_keys:
        ...
        compare_dataarrays(
            dict1[key], out_val, compare_coordinate_values=False
        )
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_sub(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
    ...
    for key in unshared_keys:
        ...
        if key in dict1:
            ...
            compare_dataarrays(
                out[key], out_val, compare_coordinate_values=False
            )
        else:
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_isub(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_scale(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_iscale(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_addsub(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
    ...
    #
    out = op.addsub(
        dict1, dict2, dict3, field_properties=field_properties_passed
    )
    for key in shared_keys:
        # with subtests.test(key=key):
        units = field_properties[key]["units"]
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_iaddsub(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_fma(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
    ...
    #
    op.fma(
        dict1, dict2, f, out=out_a, field_properties=field_properties_passed
    )
    for key in shared_keys:
        # with subtests.test(key=key):
        units = field_properties[key]["units"]
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_sts_rk2_0(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
...
@pytest.mark.parametrize("backend", conf_backend)
@pytest.mark.parametrize("dtype", conf_dtype)
def test_sts_rk3ws_0(data, backend, dtype, subtests):
    # ========================================
    # random data generation
    # ========================================
    domain = data.draw(
