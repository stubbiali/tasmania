...
def validation(flux_scheme, domain, field, timestep, backend):
    ...
    compare_arrays(
        ws.flux_sqv_x[nb - 1 : -nb, nb - 1 : -nb],
        flux_sqv_x[nb - 1 : -nb, nb - 1 : -nb],
    )
    compare_arrays(
        ws.flux_sqv_y[nb - 1 : -nb, nb - 1 : -nb],
        flux_sqv_y[nb - 1 : -nb, nb - 1 : -nb],
    )

    flux_sqc_x, flux_sqc_y = get_fluxes(u, v, sqc)
    compare_arrays(
        ws.flux_sqc_x[nb - 1 : -nb, nb - 1 : -nb],
        flux_sqc_x[nb - 1 : -nb, nb - 1 : -nb],
    )
    compare_arrays(
        ws.flux_sqc_y[nb - 1 : -nb, nb - 1 : -nb],
        flux_sqc_y[nb - 1 : -nb, nb - 1 : -nb],
    )

    flux_sqr_x, flux_sqr_y = get_fluxes(u, v, sqr)
    compare_arrays(
        ws.flux_sqr_x[nb - 1 : -nb, nb - 1 : -nb],
        flux_sqr_x[nb - 1 : -nb, nb - 1 : -nb],
    )
    compare_arrays(
        ws.flux_sqr_y[nb - 1 : -nb, nb - 1 : -nb],
        flux_sqr_y[nb - 1 : -nb, nb - 1 : -nb],
    )
