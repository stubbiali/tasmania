...
def test_first_order(data):
    ...
    pphi = data.draw(
        st_raw_field(
            (pgrid.nx + dnx, pgrid.ny + dny, pgrid.nz + dnz),
            min_value=1e-10,
            max_value=1e10,
            backend=backend,
            dtype=dtype,
    ...
    cphi = data.draw(
        st_raw_field(
            (cgrid.nx + dnx, cgrid.ny + dny, cgrid.nz + dnz),
            min_value=1e-10,
            max_value=1e10,
            backend=backend,
            dtype=dtype,
    ...
    # test
    # ========================================
    first_order_validation(pphi, depth, nb, backend, halo)
    first_order_validation(cphi, depth, nb, backend, halo)
...
def test_second_order(data):
    ...
    # test
    # ========================================
    second_order_validation(pphi, depth, nb, backend, halo)
    second_order_validation(cphi, depth, nb, backend, halo)
...
def test_third_order(data):
    ...
    # test
    # ========================================
    third_order_validation(pphi, depth, nb, backend, halo)
    third_order_validation(cphi, depth, nb, backend, halo)
