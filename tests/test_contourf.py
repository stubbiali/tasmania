...
def test_contourf_xy_velocity(isentropic_dry_data, drawer_topography_2d):
	# field to plot
...
@pytest.mark.mpl_image_compare(baseline_dir=baseline_dir)
def test_contourf_xy_pressure(isentropic_dry_data, drawer_topography_2d):
	# field to plot
...
@pytest.mark.mpl_image_compare(baseline_dir=baseline_dir)
def test_contourf_xz_velocity(isentropic_dry_data, drawer_topography_1d):
	# field to plot
...
@pytest.mark.mpl_image_compare(baseline_dir=baseline_dir)
def test_contourf_yz_velocity(isentropic_dry_data, drawer_topography_1d):
	# field to plot
