...
def test_upwind(data):
    ...
    state["tendency_of_air_potential_temperature"] = make_dataarray_3d(
...
def _test_prescribed_surface_heating(data):
    ...
    state = {
        "time": time,
        "air_pressure": make_dataarray_3d(field[:, :, : grid.nz], grid, "Pa"),
        "air_pressure_on_interface_levels": make_dataarray_3d(field, grid, "Pa"),
        "height_on_interface_levels": make_dataarray_3d(field, grid, "m"),
    }
