...
# simulation length
timestep = timedelta(seconds=0.3125)
niter = int(5 * 60 * 60 / timestep.total_seconds())

# output
save = True
save_frequency = 640
save_iterations = list(range(0, 11520, save_frequency)) + list(
    range(11520, niter + 1, 11520)
)
filename = "/scratch/snx3000tds/subbiali/data/pdc_paper/isentropic_diagnostic/isentropic_moist_{}_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_{}_L{}_H{}_u{}_rh{}{}{}{}{}{}{}{}_ssus_{}_oop.nc".format(
