...
save = True
save_frequency = 320
save_iterations = list(range(0, 5760, save_frequency)) + list(range(5760, niter + 1, 5760))
filename = (
    "/scratch/snx3000tds/subbiali/data/pdc_paper/isentropic_diagnostic/isentropic_moist_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_"
