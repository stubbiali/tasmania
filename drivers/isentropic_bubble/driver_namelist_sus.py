...
drawer1 = taz.Contourf(
	pgrid, 'horizontal_velocity', 'm s^-1', z=-1,
...
drawer2 = taz.Quiver(
	pgrid, z=-1, xaxis_units='km', yaxis_units='km',
...
drawer3 = taz.Contourf(
	pgrid, 'x_velocity', 'm s^-1', y=int(nl.ny/2),
...
topo_drawer = taz.LineProfile(
	pgrid, 'topography', 'km', y=int(nl.ny/2), z=-1, axis_units='km',
