...
# Wrap the components in a ConcurrentCoupling object
fast_tends = (
    taz.ConcurrentCoupling(*args, execution_policy="serial") if len(args) > 0 else None
)
...
for i in range(nt):
    ...
    # Purpose-costumed code
    # ========================================================
    state["tendency_of_x_momentum_isentropic"] = slow_tendencies[
        "x_momentum_isentropic"
    ]
    state["tendency_of_y_momentum_isentropic"] = slow_tendencies[
