...
# simulation length
timestep = timedelta(seconds=12)
niter    = int(12*60*60 / timestep.total_seconds())

# output
filename = \
	'../../data/smolarkiewicz_{}_{}_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_ns{}_' \
	'{}_L{}_H{}_u{}_wf3_f_sus.nc'.format(
		time_integration_scheme, horizontal_flux_scheme, vertical_flux_scheme,
		physics_time_integration_scheme, nx, ny, nz, 
		int(timestep.total_seconds()), niter, substeps,
		topo_type, int(_width.to_units('m').values.item()),
