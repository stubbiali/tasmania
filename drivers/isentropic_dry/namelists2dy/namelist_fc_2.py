...
nx = 1
domain_y = DataArray([-220, 220], dims="y", attrs={"units": "km"}).to_units(
    "m"
)
ny = 201
domain_z = DataArray(
...
save = True
save_frequency = -1
filename = "/scratch/snx3000tds/subbiali/data/isentropic_dry_{}_{}_ny{}_nz{}_dt{}_nt{}_" "{}_L{}_H{}_u{}_T{}{}{}{}_fc_{}.nc".format(
