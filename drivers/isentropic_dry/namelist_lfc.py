...
backend_kwargs["backend_opts"] = (
    {"verbose": True}
    if backend_kwargs["backend"] in ("gtx86", "gtmc", "gtcuda")
    else None
)
...
save = False
save_frequency = -1
filename = "/scratch/snx3000tds/subbiali/data/isentropic_dry_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_" "{}_L{}_H{}_u{}_{}{}{}{}_lfc_{}.nc".format(
