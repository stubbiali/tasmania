...
diff_coeff = DataArray(1.0, attrs={"units": "s^-1"})
diff_coeff_max = DataArray(1.0, attrs={"units": "s^-1"})
diff_damp_depth = 0
...
# output
filename = (
    "../../data/isentropic_dry_{}_{}_pg{}_nx{}_ny{}_nz{}_dt{}_nt{}_"
    "{}_L{}_H{}_u{}{}{}{}{}_lcc.nc".format(
