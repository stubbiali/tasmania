...
niter = 100  # int(12 * 60 * 60 / timestep.total_seconds())

# output
save = False
save_frequency = -1
filename = "/scratch/snx3000tds/subbiali/data/isentropic_dry_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_" "{}_L{}_H{}_u{}_{}{}{}{}_fc_{}.nc".format(
