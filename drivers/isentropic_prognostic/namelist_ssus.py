...
niter = 20  # int(1 * 60 * 60 / timestep.total_seconds())

# output
save = False
save_frequency = 5
filename = """../../data/isentropic_prognostic/isentropic_moist_{}_{}{}_{}_
    nx{}_ny{}_nz{}_dt{}_nt{}_{}_L{}_H{}_u{}_rh{}{}{}{}{}{}{}_ssus_{}
    .nc""".format(
...
logfile = f"namelist_ssus_{backend_kwargs['backend']}.log"
