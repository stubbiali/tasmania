...
# simulation length
timestep = timedelta(seconds=0.625)
niter = int(5 * 60 * 60 / timestep.total_seconds())

# output
save = True
save_frequency = 320
save_iterations = list(range(0, 5760, save_frequency)) + list(
    range(5760, niter + 1, 5760)
)
filename = "/scratch/snx3000tds/subbiali/data/pdc_paper/isentropic_prognostic/isentropic_moist_{}_{}_{}_" "nx{}_ny{}_nz{}_dt{}_nt{}_{}_L{}_H{}_u{}_rh{}{}{}{}{}{}{}{}_ssus_{}.nc".format(
