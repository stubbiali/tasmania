...
# simulation length
timestep = timedelta(seconds=1.25)
niter = int(5 * 60 * 60 / timestep.total_seconds())

# output
save = True
save_frequency = 160
save_iterations = list(range(0, 2880, save_frequency)) + list(
    range(2880, niter + 1, 2880)
)
filename = "/scratch/snx3000tds/subbiali/data/pdc_paper/isentropic_prognostic/isentropic_moist_{}_{}_fe{}_" "nx{}_ny{}_nz{}_dt{}_nt{}_{}_L{}_H{}_u{}_rh{}{}{}{}{}{}{}{}_ssus_{}.nc".format(
