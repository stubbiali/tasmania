...
init_x_velocity = DataArray(2.0, attrs={'units': 'm s^-1'})
...
frequency_fw						= DataArray(0.0, attrs={'units': 'h^-1'})
...
filename        = '../data/smolarkiewicz_{}_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_{}_L{}_u{}_f_cc_1.nc'.format(
