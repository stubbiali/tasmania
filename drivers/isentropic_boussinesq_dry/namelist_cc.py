...
# metric terms
advection_scheme = 'fifth_order_upwind'
...
diff_coeff          = DataArray(16e3, attrs={'units': 's^-1'})
diff_coeff_max      = DataArray(16e3, attrs={'units': 's^-1'})
diff_damp_depth     = 0
...
# output
filename = \
	'../../data/isentropic_boussinesq_dry_{}_{}_pg{}_nx{}_ny{}_nz{}_dt{}_nt{}_' \
	'{}_L{}_H{}_u{}{}{}{}{}_cc.nc'.format(
