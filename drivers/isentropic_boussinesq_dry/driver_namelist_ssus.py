...
args_before_dynamics.append({'component': pg, 'time_integrator': 'forward_euler', 'substeps': 1})
args_after_dynamics.append({'component': pg, 'time_integrator': 'forward_euler', 'substeps': 1})
...
if nl.diff:
	...
	args_before_dynamics.append({'component': hd, 'time_integrator': ptis, 'substeps': 1})
