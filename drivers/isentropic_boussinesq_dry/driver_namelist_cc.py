...
# The initial state
# ============================================================
state = taz.get_isentropic_boussinesq_state_from_brunt_vaisala_frequency(
...
# # component calculating the compensation terms accounting for the
# # incompressible and Boussinesq approximation
# ibt = taz.IsentropicBoussinesqTendency(
# 	domain, advection_scheme=nl.advection_scheme, moist=False,
...
from tasmania.python.isentropic.physics.boussinesq_diagnostics import \
	IsentropicBoussinesqDiagnostics1, IsentropicBoussinesqDiagnostics2, \
	IsentropicBoussinesqDiagnostics3, IsentropicBoussinesqDiagnostics4, \
	IsentropicBoussinesqDiagnostics5, IsentropicBoussinesqDiagnostics6, \
	IsentropicBoussinesqDiagnostics7
pt = state['air_pressure_on_interface_levels'][0, 0, 0]
inter_diags = IsentropicBoussinesqDiagnostics7(
...
# The dynamical core
# ============================================================
dycore = taz.IsentropicBoussinesqMinimalDynamicalCore(
	domain, moist=False,
	# parameterizations
