...
inter_diags = IsentropicBoussinesqDiagnostics7(
    domain, grid_type="numerical", moist=False, pt=pt, backend=nl.backend, dtype=nl.dtype
)
...
if nl.smooth:
    ...
    vc = taz.IsentropicVelocityComponents(domain, backend=nl.backend, dtype=nl.dtype)
    args.append(vc)
