...
frequency							   = DataArray(np.pi/12.0, attrs={'units': 'h^-1'})
...
niter    = int(48*60*60 / timestep.total_seconds())

filename        = '../data/smolarkiewicz_{}_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_{}_L{}_u{}_f_cc.nc'.format(
