...
ny = 81
domain_z = DataArray([340, 240], dims="potential_temperature", attrs={"units": "K"})
nz = 60
...
save_frequency = 4
filename = (
    "/scratch/snx3000tds/subbiali/data/prognostic-saturation-290/isentropic_moist_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_"
