...
domain_x = DataArray([-264, 264], dims='x', attrs={'units': 'km'}).to_units('m')
nx       = 61
domain_y = DataArray([-264, 264], dims='y', attrs={'units': 'km'}).to_units('m')
ny       = 61
...
# Coupling
coupling_time_integration_scheme = 'rk3cosmo'
...
filename        = '../data/smolarkiewicz_{}_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_{}_L{}_H{}_u{}_wf1_sus.nc'.format(
