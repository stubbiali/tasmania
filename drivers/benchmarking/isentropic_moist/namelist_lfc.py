...
exec_info_csv = os.path.join(
    prefix, f"isentropic_moist_exec_lfc_{backend}.csv"
)
run_info_csv = os.path.join(prefix, "isentropic_moist_run_lfc.csv")
stencil_info_csv = os.path.join(prefix, "isentropic_moist_stencil_lfc.csv")
log_txt = os.path.join(prefix, f"isentropic_moist_log_lfc_{backend}.txt")
