...
exec_info_csv = os.path.join(
    prefix, f"isentropic_moist_exec_sts_{backend}.csv"
)
run_info_csv = os.path.join(prefix, "isentropic_moist_run_sts.csv")
stencil_info_csv = os.path.join(prefix, "isentropic_moist_stencil_sts.csv")
log_txt = os.path.join(prefix, f"isentropic_moist_log_sts_{backend}.txt")
