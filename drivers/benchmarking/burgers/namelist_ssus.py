...
exec_info_csv = os.path.join(prefix, f"burgers_exec_ssus_{backend}.csv")
run_info_csv = os.path.join(prefix, "burgers_run_ssus.csv")
stencil_info_csv = os.path.join(prefix, "burgers_stencil_ssus.csv")
log_txt = os.path.join(prefix, f"burgers_log_ssus_{backend}.txt")
