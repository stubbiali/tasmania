...
exec_info_csv = os.path.join(prefix, f"burgers_exec_sus_{backend}.csv")
run_info_csv = os.path.join(prefix, "burgers_run_sus.csv")
stencil_info_csv = os.path.join(prefix, "burgers_stencil_sus.csv")
log_txt = os.path.join(prefix, f"burgers_log_sus_{backend}.txt")
