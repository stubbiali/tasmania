...
exec_info_csv = os.path.join(prefix, f"isentropic_dry_exec_ssus_{backend}.csv")
run_info_csv = os.path.join(prefix, "isentropic_dry_run_ssus.csv")
log_txt = os.path.join(prefix, f"isentropic_dry_log_ssus_{backend}.txt")
