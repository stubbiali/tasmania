...
if "nid" in hostname:
    ...
    prefix = "../timing/oop"
exec_info_csv = os.path.join(prefix, f"isentropic_dry_exec_lfc_{backend}.csv")
run_info_csv = os.path.join(prefix, "isentropic_dry_run_lfc.csv")
log_txt = os.path.join(prefix, f"isentropic_dry_log_lfc_{backend}.txt")
