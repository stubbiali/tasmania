...
parser.add_argument(
	'-n', metavar='NAMELIST', type=str, default='namelist_lcc.py',
...
if nl.diff:
	...
	diff = taz.IsentropicHorizontalDiffusion(
		domain, nl.diff_type, nl.diff_coeff, nl.diff_coeff_max,
		nl.diff_damp_depth, moist=False, **nl.gt_kwargs
	)
	args.append(diff)
...
ke = taz.KesslerMicrophysics(
	...
	collection_rate=nl.collection_rate, **nl.gt_kwargs
)
...
if nl.smooth:
	...
	hs = taz.IsentropicHorizontalSmoothing(
		...
		nl.smooth_damp_depth, **nl.gt_kwargs
	)
	args.append(hs)
