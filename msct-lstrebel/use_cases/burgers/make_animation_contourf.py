...
#
"""
Utility to generate an animation showing the time evolution of the contourf of a certain field.
"""
...
# field 				Field to plot; options: 'u', 'v', 'speed'
# fontsize         		Font size
# figsize			 	Figure size
# title            		Figure title
...
destination			= 'test_zhao_upwind_u.mp4'	
field 				= 'u'				
fontsize         	= 16			
figsize			 	= [7,8]		
...
with writer.saving(fig, destination, nt):
	...
	for n in range(nt):
		...
		# Plot the field
		surf = plt.contourf(x, y, var[:, :, n], color_scale, cmap = cm)
