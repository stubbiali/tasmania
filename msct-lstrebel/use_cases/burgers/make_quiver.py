...
#
"""
Utility to generate the quiver plot of the velocity field.
"""
...
if cmap_name is None:
	q = plt.quiver(x[::x_step, ::y_step], y[::x_step, ::y_step], 
				   u[::x_step, ::y_step, time_level], v[::x_step, ::y_step, time_level]) 
else:	
	speed = np.sqrt
	q = plt.quiver(x[::x_step, ::y_step], y[::x_step, ::y_step], 
				   u[::x_step, ::y_step, time_level], v[::x_step, ::y_step, time_level], 
				   speed[::x_step, ::y_step, time_level], cmap = cm)
