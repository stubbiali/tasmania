...
% TODO short section description
...
%For example the partitioning by PyMetis shown in fig. \ref{fig:pymetis1}, partitions the domain in the following way:
%green 26, orange 27, blue 24, and gray 51 subdivisions.
