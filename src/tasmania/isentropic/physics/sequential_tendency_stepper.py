...
class IsentropicVerticalAdvection(SequentialTendencyStepper, StencilFactory):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        core = None
        for arg in args:
            core = arg if isinstance(arg, IsentropicImplicitVerticalAdvectionDiagnostic) else None
        ...
        super(SequentialTendencyStepper, self).__init__(backend, backend_options, storage_options)

        # overwrite properties
        self.input_properties = core.input_properties.copy()
        self.provisional_input_properties = core.input_properties.copy()
        self.provisional_input_properties.pop("tendency_of_air_potential_temperature", None)
        ...
        self._stgz = (
            "tendency_of_air_potential_temperature_on_interface_levels" in self.input_properties
        )
