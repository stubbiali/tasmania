...
class ZhaoStateFactory(StencilFactory):
    ...
    def __call__(self, time: Datetime, grid: Grid) -> DataArrayDict:
        ...
        u[...] = self.as_storage(data=self._solution_factory(time, grid, field_name="x_velocity"))
        ...
        v[...] = self.as_storage(data=self._solution_factory(time, grid, field_name="y_velocity"))
