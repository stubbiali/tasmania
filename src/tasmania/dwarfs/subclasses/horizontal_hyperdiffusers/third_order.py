...
class ThirdOrder(HorizontalHyperDiffusion):
    ...
    def _hyperdiffusion_numpy(in_phi, in_gamma, out_phi, *, dx, dy, origin, domain):
        ...
        out_phi[ib:ie, jb:je, k] = in_gamma[ib:ie, jb:je, k] * laplacian(dx, dy, lap1)
...
class ThirdOrder1DX(HorizontalHyperDiffusion):
    ...
    def _hyperdiffusion_numpy(in_phi, in_gamma, out_phi, *, dx, dy, origin, domain):
        ...
        out_phi[ib:ie, jb:je, k] = in_gamma[ib:ie, jb:je, k] * laplacian_x(dx, lap1)
...
class ThirdOrder1DY(HorizontalHyperDiffusion):
    ...
    def _hyperdiffusion_numpy(in_phi, in_gamma, out_phi, *, dx, dy, origin, domain):
        ...
        out_phi[ib:ie, jb:je, k] = in_gamma[ib:ie, jb:je, k] * laplacian_y(dy, lap1)
