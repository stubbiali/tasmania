...
class SecondOrder(HorizontalHyperDiffusion):
    ...
    def _hyperdiffusion_numpy(in_phi, in_gamma, out_phi, *, dx, dy, origin, domain):
        ...
        out_phi[ib:ie, jb:je, k] = in_gamma[ib:ie, jb:je, k] * laplacian(dx, dy, lap0)
...
class SecondOrder1DX(HorizontalHyperDiffusion):
    ...
    def _hyperdiffusion_numpy(in_phi, in_gamma, out_phi, *, dx, dy, origin, domain):
        ...
        out_phi[ib:ie, jb:je, k] = in_gamma[ib:ie, jb:je, k] * laplacian_x(dx, lap0)
...
class SecondOrder1DY(HorizontalHyperDiffusion):
    ...
    def _hyperdiffusion_numpy(in_phi, in_gamma, out_phi, *, dx, dy, origin, domain):
        ...
        out_phi[ib:ie, jb:je, k] = in_gamma[ib:ie, jb:je, k] * laplacian_y(dy, lap0)
