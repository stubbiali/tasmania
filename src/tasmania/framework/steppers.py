...
class TendencyStepper(AbstractFactory, SymplTendencyStepper):
    ...
    def __init__(
        ...
        *args: TendencyComponent,
        ...
        super(AbstractFactory, self).__init__(tendency_component, enable_checks=enable_checks)
...
class SequentialTendencyStepper(AbstractFactory, SymplSequentialTendencyStepper):
    """
    Callable abstract base class which steps a model state based on the
    tendencies calculated by a set of wrapped prognostic components.
    """
