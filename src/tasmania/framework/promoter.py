...
class FromDiagnosticToTendency(BaseFromDiagnosticToTendency, DomainComponent, StencilFactory):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._input_operator = InflowComponentOperator.factory("input_properties", self)
...
class FromTendencyToDiagnostic(BaseFromTendencyToDiagnostic, DomainComponent, StencilFactory):
    """
    ...
    def __init__(
        ...
        *,
        ...
        if enable_checks:
            # instantiate dynamic checker
            self._input_checker = InflowComponentChecker.factory("input_tendency_properties", self)
        ...
        # instantiate dynamic operators
        self._input_operator = InflowComponentOperator.factory("input_tendency_properties", self)
    ...
    def __call__(
        ...
        # extract or allocate output buffers
        raw_diagnostics = self._diagnostic_inflow_operator.get_ndarray_dict(out)
