...
if cp:
    ...
    def _(data: np.ndarray, *, storage_options: Optional[StorageOptions] = None) -> cp.ndarray:
        return cp.asarray(data)

    @as_storage_cupy.register
    def _(data: cp.ndarray, *, storage_options: Optional[StorageOptions] = None) -> cp.ndarray:
        return data
