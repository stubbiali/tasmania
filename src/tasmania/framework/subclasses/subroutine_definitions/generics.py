...
def set_output_numpy(lhs: "np.ndarray", rhs: "np.ndarray", overwrite: bool) -> None:
...
if gt4py:
    ...
    @gtscript.function
    def set_output_gt4py(lhs: "GTField", rhs: "GTField", overwrite: bool) -> "GTField":
        return rhs if overwrite else lhs + rhs


if numba:
    subroutine_definition.register(set_output_numpy, "numba:cpu:numpy", "set_output")

    @subroutine_definition.register(backend="numba:cpu:stencil", stencil="set_output")
    def set_output_numba(lhs: "np.ndarray", rhs: "np.ndarray", overwrite: bool) -> "np.ndarray":
