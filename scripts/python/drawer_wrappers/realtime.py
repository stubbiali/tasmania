...
class ContourWrapper(DrawerWrapper):
	def __init__(self, loader, json_filename):
		...
		with open(json_filename, 'r') as json_file:
			...
			self._core = taz.Contour(
				loader.get_grid(), field_name, field_units, x=x, y=y, z=z,
				xaxis_name=xaxis_name, xaxis_units=xaxis_units, xaxis_y=xaxis_y, xaxis_z=xaxis_z,
				yaxis_name=yaxis_name, yaxis_units=yaxis_units, yaxis_x=yaxis_x, yaxis_z=yaxis_z,
				zaxis_name=zaxis_name, zaxis_units=zaxis_units, zaxis_x=zaxis_x, zaxis_y=zaxis_y,
...
class QuiverWrapper(DrawerWrapper):
	def __init__(self, loader, json_filename):
		...
		with open(json_filename, 'r') as json_file:
			...
			self._core = taz.Quiver(
				loader.get_grid(), x=x, y=y, z=z,
				xcomp_name=xcomp_name, xcomp_units=xcomp_units,
				ycomp_name=ycomp_name, ycomp_units=ycomp_units,
				zcomp_units=zcomp_units, zcomp_name=zcomp_name,
