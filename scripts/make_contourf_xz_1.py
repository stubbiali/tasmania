...
plot_properties = {
	'fontsize': 16,
	'title_center': '',
	'title_left': '$x$-velocity [m s$^{-1}$]', #''$u\' = u - \\bar{u}$  [10$^{-4}$ m s$^{-1}$]',
	'title_right': '',
	'x_label': '$x$ [km]',
	'x_lim': [-250, 250],
	'invert_xaxis': False,
...
filename = '../data/smolarkiewicz_rk3cosmo_fifth_order_upwind_centered_nx51_ny51_nz50_dt15_nt5760_sus_gaussian_L25000_H2250_u7.nc'
time_level = -9
