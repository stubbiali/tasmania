...
axes_properties = {
	...
	'title_right': '',
	'x_label': 'Time (UTC)',
	'x_lim': (-0.5, 24.5), #(-190, 210),
	'invert_xaxis': False,
	'x_scale': None,
	'x_ticks': range(0, 25, 6),
	'x_ticklabels': ('08:00', '14:00', '20:00', '02:00', '08:00'),
	'xaxis_minor_ticks_visible': False,
	'xaxis_visible': True,
	'y_label': '',
	'y_lim': None, #(0.0, 0.016), # (0.01, 0.09),
	'invert_yaxis': False,
	'y_scale': None,
	'y_ticks': None, #(0, 0.004, 0.008, 0.012, 0.016), #(0.01, 0.03, 0.05, 0.07, 0.09),
	'y_ticklabels': None,
