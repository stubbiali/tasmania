...
from tasmania.python.utils.data_utils import get_physical_constants, make_dataarray_3d
...
def get_isentropic_boussinesq_state_from_brunt_vaisala_frequency(
    ...
    state = {
        "time": time,
        "air_isentropic_density": make_dataarray_3d(
            s, grid, "kg m^-2 K^-1", name="air_isentropic_density"
        ),
        "air_pressure_on_interface_levels": make_dataarray_3d(
            p, grid, "Pa", name="air_pressure_on_interface_levels"
        ),
        "exner_function_on_interface_levels": make_dataarray_3d(
            exn, grid, "J K^-1 kg^-1", name="exner_function_on_interface_levels"
        ),
        "height_on_interface_levels": make_dataarray_3d(
            h, grid, "m", name="height_on_interface_levels"
        ),
        "montgomery_potential": make_dataarray_3d(
            mtg, grid, "J kg^-1", name="montgomery_potential"
        ),
        "dd_montgomery_potential": make_dataarray_3d(
            ddmtg, grid, "m^2 K^-2 s^-2", name="dd_montgomery_potential"
        ),
        "x_momentum_isentropic": make_dataarray_3d(
            su, grid, "kg m^-1 K^-1 s^-1", name="x_momentum_isentropic"
        ),
        "x_velocity_at_u_locations": make_dataarray_3d(
            u, grid, "m s^-1", name="x_velocity_at_u_locations"
        ),
        "y_momentum_isentropic": make_dataarray_3d(
            sv, grid, "kg m^-1 K^-1 s^-1", name="y_momentum_isentropic"
        ),
        "y_velocity_at_v_locations": make_dataarray_3d(
