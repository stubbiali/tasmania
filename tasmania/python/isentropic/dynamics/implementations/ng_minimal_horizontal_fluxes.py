...
class Upwind(NGIsentropicMinimalHorizontalFlux):
	"""
	Upwind scheme.
	"""
	extent = 1
...
class Centered(NGIsentropicMinimalHorizontalFlux):
	"""
	Centered scheme.
	"""
	extent = 1
...
class MacCormack(NGIsentropicMinimalHorizontalFlux):
	"""
	MacCormack scheme.
	"""
	extent = 1
...
class ThirdOrderUpwind(NGIsentropicMinimalHorizontalFlux):
	"""
...
class FifthOrderUpwind(NGIsentropicMinimalHorizontalFlux):
	"""
