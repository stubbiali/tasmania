...
This module contains:
	ForwardEulerSI(NGIsentropicPrognostic)
	CenteredSI(NGIsentropicPrognostic)
	RK3WSSI(NGIsentropicPrognostic)
"""
import numpy as np
...
from tasmania.python.isentropic.dynamics.fluxes import \
	NGIsentropicHorizontalFlux, NGIsentropicMinimalHorizontalFlux
...
class ForwardEulerSI(NGIsentropicPrognostic):
...
class CenteredSI(NGIsentropicPrognostic):
	pass


class RK3WSSI(NGIsentropicPrognostic):
...
class SIL3(NGIsentropicPrognostic):
