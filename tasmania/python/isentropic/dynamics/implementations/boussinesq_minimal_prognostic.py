...
class Centered(IsentropicBoussinesqMinimalPrognostic):
    ...
    def _stage_stencil_initialize(self, tendencies):
        ...
        _inputs = {
            ...
            "in_ddmtg_old": self._in_ddmtg_old,
        }
        _outputs = {
            "out_s": self._out_s,
            "out_su": self._out_su,
    ...
    def _stage_stencil_defs(
        ...
        fluxes = self._hflux(
            i, j, dt, in_s, in_u, in_v, in_su, in_sv, in_ddmtg, in_sqv, in_sqc, in_sqr
        )
        ...
        out_ddmtg[i, j] = in_ddmtg_old[i, j] - 2.0 * dt * (
...
class RK2(IsentropicBoussinesqMinimalPrognostic):
    ...
    def _stage_stencil_initialize(self, tendencies):
        ...
        _inputs = {
            ...
            "in_ddmtg": self._in_ddmtg,
            "in_ddmtg_int": self._in_ddmtg_int,
        }
        _outputs = {
            "out_s": self._out_s,
            "out_su": self._out_su,
...
class RK3(IsentropicBoussinesqMinimalPrognostic):
    ...
    def _stage_stencil_first_defs(
        ...
        if not self._moist:
            return out_s0, out_s, out_su0, out_su, out_sv0, out_sv, out_ddmtg0, out_ddmtg
        else:
            return (
                out_s0,
                out_s,
    ...
    def _stage_stencil_second_defs(
        ...
        out_ddmtg[i, j] = (
            in_ddmtg[i, j] + b21 * in_ddmtg0[i, j] + (a2 - b21) * out_ddmtg1[i, j]
        )
        ...
        if not self._moist:
            return out_s1, out_s, out_su1, out_su, out_sv1, out_sv, out_ddmtg1, out_ddmtg
        else:
            return (
                out_s1,
                out_s,
