...
class IsentropicBoussinesqMinimalDynamicalCore(DynamicalCore):
	...
	def __init__(
		...
		substeps=0, fast_tendencies=None, fast_diagnostics=None, moist=False,
		time_integration_scheme='forward_euler', horizontal_flux_scheme='upwind',
