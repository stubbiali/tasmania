...
class StaticOperator:
    ...
    provisional_input_operator = StaticComponentOperator.factory(
    ...
    def get_provisional_input_properties(
        ...
        for component in splitter.components:
            provisional_input_properties = (
                cls.provisional_input_operator.get_properties_with_dims(
                    component
                )
            )
    ...
    def get_output_properties(
        ...
        for component in splitter.components:
            if not cls.is_diagnostic_component(component):
                diagnostic_properties = (
                    cls.diagnostic_operator.get_properties_with_dims(component)
                )
