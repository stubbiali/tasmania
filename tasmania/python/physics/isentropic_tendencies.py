...
from tasmania.python.dynamics.isentropic_fluxes import VerticalHomogeneousIsentropicFlux
...
class VerticalIsentropicAdvection(TendencyComponent):
	...
	def __init__(
		...
		**kwargs :
		...
		self._vflux = VerticalHomogeneousIsentropicFlux.factory(flux_scheme, grid, moist)
