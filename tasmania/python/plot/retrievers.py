    ...
    def __call__(self, state: typing.DataArrayDict) -> typing.array_t:
        ...
        if field_name in state:  # model variable
            ...
            try:
                ...
                try:
                    s = (
                        state["air_isentropic_density"][x, y, z]
                        .to_units("kg m^-2 K^-1")
                        .values
                    )
                    su = (
                        state["x_momentum_isentropic"][x, y, z]
                        .to_units("kg m^-1 K^-1 s^-1")
                        .values
                    )
                    sv = (
                        state["y_momentum_isentropic"][x, y, z]
                        .to_units("kg m^-1 K^-1 s^-1")
                        .values
                    )
                    u, v = su / s, sv / s
            ...
            factor = (
                ...
                else DataArray(1, attrs={"units": "m s^-1"})
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        raise RuntimeError(
                            "Sorry, don't know how to retrieve 'x_velocity'."
                        )
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        raise RuntimeError(
                            "Sorry, don't know how to retrieve 'y_velocity'."
                        )
            ...
            try:
                return to_units(
                    grid.height_on_interface_levels[x, y, z], field_units
                ).values
            except AttributeError:
                pass
            ...
            raise RuntimeError(
                "Sorry, don't know how to retrieve '{}'.".format(field_name)
            )
