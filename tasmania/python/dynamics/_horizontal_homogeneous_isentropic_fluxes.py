...
This module contains:
	Upwind(HorizontalHomogeneousIsentropicFlux)
	Centered(HorizontalHomogeneousIsentropicFlux)
	MacCormack(HorizontalHomogeneousIsentropicFlux)
	FifthOrderUpwind(HorizontalHomogeneousIsentropicFlux)
"""
import gridtools as gt
from tasmania.python.dynamics.isentropic_fluxes import HorizontalHomogeneousIsentropicFlux
from tasmania.python.dynamics._horizontal_isentropic_fluxes import \
...
class Upwind(HorizontalHomogeneousIsentropicFlux):
	"""
...
class Centered(HorizontalHomogeneousIsentropicFlux):
	"""
	Class which inherits
	:class:`~tasmania.dynamics.isentropic_fluxes.HorizontalHomogeneousIsentropicFlux`
...
class MacCormack(HorizontalHomogeneousIsentropicFlux):
	"""
	Class which inherits
	:class:`~tasmania.dynamics.isentropic_fluxes.HorizontalHomogeneousIsentropicFlux`
	...
	def _get_maccormack_horizontal_predicted_value_s(self, i, j, k, dt, s, su, sv, s_tnd):
	...
	def _get_maccormack_horizontal_predicted_value_su(self, i, j, k, dt,
													  u_unstg, v_unstg, su, su_tnd):
		dx, dy = self._grid.dx.values.item(), self._grid.dy.values.item()
		su_prd = gt.Equation()
	...
	def _get_maccormack_horizontal_predicted_value_sv(self, i, j, k, dt,
													  u_unstg, v_unstg, sv, sv_tnd):
		dx, dy = self._grid.dx.values.item(), self._grid.dy.values.item()
		sv_prd = gt.Equation()
...
class ThirdOrderUpwind(HorizontalHomogeneousIsentropicFlux):
	"""
	Class which inherits
	:class:`~tasmania.dynamics.isentropic_fluxes.HorizontalHomogeneousIsentropicFlux`
...
class FifthOrderUpwind(HorizontalHomogeneousIsentropicFlux):
	"""
	Class which inherits
	:class:`~tasmania.dynamics.isentropic_fluxes.HorizontalHomogeneousIsentropicFlux`
