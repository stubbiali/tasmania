...
class HorizontalIsentropicFlux:
	...
	def factory(scheme, grid, moist_on):
		...
		"""
		import tasmania.python.dynamics._horizontal_isentropic_fluxes as module
		if scheme == 'upwind':
...
class VerticalIsentropicFlux:
	...
	def factory(scheme, grid, moist_on):
		...
		obj :
			...
			specified by :data:`scheme`.
		"""
		import tasmania.python.dynamics._vertical_isentropic_fluxes as module
		if scheme == 'upwind':
...
class HorizontalNonconservativeIsentropicFlux:
	...
	def factory(scheme, grid, moist_on):
		...
		obj :
			...
			specified by :data:`scheme`.
		"""
		import tasmania.python.dynamics._nonconservative_isentropic_fluxes as module
		if scheme == 'centered':
...
class HorizontalHomogeneousIsentropicFlux:
	...
	def factory(scheme, grid, moist_on):
		...
		Zeman, C. (2016). An isentropic mountain flow model with iterative \
			synchronous flux correction. *Master thesis, ETH Zurich*.
		"""
		import tasmania.python.dynamics._horizontal_homogeneous_isentropic_fluxes as module
		if scheme == 'upwind':
			return module.Upwind(grid, moist_on)
		elif scheme == 'centered':
			return module.Centered(grid, moist_on)
...
class VerticalHomogeneousIsentropicFlux:
	...
	def factory(scheme, grid, moist_on):
		...
		Zeman, C. (2016). An isentropic mountain flow model with iterative \
			synchronous flux correction. *Master thesis, ETH Zurich*.
		"""
		import tasmania.python.dynamics._vertical_homogeneous_isentropic_fluxes as module
		if scheme == 'upwind':
			return module.Upwind(grid, moist_on)
		elif scheme == 'centered':
			return module.Centered(grid, moist_on)
