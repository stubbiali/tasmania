...
import namelist_isentropic_dry_ssus_fused as nl
...
if nl.coriolis:
	...
	tendencies.append(cf)

cc = taz.ConcurrentCoupling(*tendencies)
args_before_dynamics.append({'component': cc, 'time_integrator': ptis, 'substeps': 1})
args_after_dynamics.append({'component': cc, 'time_integrator': ptis, 'substeps': 1})
...
args_before_dynamics.append({'component': ivc})

# Wrap the components in two SequentialUpdateSplitting objects
physics_before_dynamics = taz.SequentialUpdateSplitting(*args_before_dynamics)
