...
domain_x = DataArray([-400, 400], dims="x", attrs={"units": "km"}).to_units(
    "m"
)
nx = 81
domain_y = DataArray([-400, 400], dims="y", attrs={"units": "km"}).to_units(
    "m"
)
ny = 81
domain_z = DataArray(
...
# output
filename = (
    "../../data/isentropic_dry_{}_{}_nx{}_ny{}_nz{}_dt{}_nt{}_"
    "{}_L{}_H{}_u{}_f_sus_fused.nc".format(
        ...
        niter,
        topo_type,
        int(topo_kwargs["topo_width_x"].to_units("m").values.item()),
