...
# Grid instantiation
#
domain_x, nx = [0.0, 10.0], 101
domain_y, ny = [-5.0, 5.0], 51
domain_z, nz = [0.0, 20.0], 21
...
F1_x, F2_x, F3_x, F4_x, F5_x, F6_x, F1_y, F2_y, F3_y, F4_y, F5_y, F6_y = flux(
    i, j, k, dt, s, u, v, mtg, U, V, Qv, Qc, Qr
)
