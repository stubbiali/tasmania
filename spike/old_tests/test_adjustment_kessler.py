...
from tasmania.parameterizations.adjustment_microphysics import (
    AdjustmentMicrophysics,
)
from tasmania.storages.state_isentropic import StateIsentropic

domain_x, nx = [0.0, 500.0e3], 100
domain_y, ny = [0.0, 500.0e3], 100
domain_z, nz = [0.0, 500.0e3], 100
...
T = 273.0 + np.random.rand(nx, ny, nz)
