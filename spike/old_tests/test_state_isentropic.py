...
from storages.state_isentropic_nonconservative import (
    StateIsentropicNonconservative,
)
...
sinc = StateIsentropicNonconservative(
...
sic = StateIsentropicConservative(
    datetime(year=1992, month=2, day=20),
    g,
    s,
    u,
